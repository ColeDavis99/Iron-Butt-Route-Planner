...
class RoadNodeHandler(osmium.SimpleHandler):
    ...
    def node(self, n):
        if n.id in self.road_node_ids and n.location.valid():
            self.nodes[n.id] = (n.location.lat, n.location.lon)

# Step 1: Collect road node IDs and edges
way_handler = RoadWayHandler()
# way_handler.apply_file("D:\\OpenStreetMap_Datasets_And_Images\Central_US_Polygon_7ea12566-1eea-478a-8f3b-33dc53fad01e.osm.pbf", locations=True)
way_handler.apply_file("D:\\OpenStreetMap_Datasets_And_Images\\Ash_Grove_f006e4cb-88e7-4a50-ae08-2e7a1ce319a8.osm.pbf", locations=True)

# Step 2: Collect only the matching node coordinates
node_handler = RoadNodeHandler(way_handler.road_node_ids)
# way_handler.apply_file("D:\\OpenStreetMap_Datasets_And_Images\Central_US_Polygon_7ea12566-1eea-478a-8f3b-33dc53fad01e.osm.pbf", locations=True)
node_handler.apply_file("D:\\OpenStreetMap_Datasets_And_Images\\Ash_Grove_f006e4cb-88e7-4a50-ae08-2e7a1ce319a8.osm.pbf", locations=True)
